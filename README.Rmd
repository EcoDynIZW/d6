...
└── unicornus_wl_sdm_smith_j
    ...
    │    ├── geo             —  main folder geospatial data
    │    │    ├── processed  —  processed geospatial data files
    │    │    └── raw        —  raw geospatial data files
    │    ├── processed       —  processed tabular data files
    │    └── raw             —  raw tabular data files
    ├── docs                 —  documents
    │   ├── admin            —  administrative docs, e.g. permits 
    │   ├── literature       —  literature used for parametrization + ms
    ...
    │   └── zz_submit.R      —  final script to run
