...
The directories created in the root folder (here `project`) is the following:
...
The full scaffolding structure including all subdirectories and addiitonal files looksl like this:
