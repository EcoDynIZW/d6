...
*Please give your project a unique and descriptive name: **lastname_year_project***

The main folders created in the root folder (here `smith_2020_unicornIBM`) are the following:
...
The full scaffolding structure including all subdirectories and addiitonal files looks like this:
