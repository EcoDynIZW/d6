...
1. [Create project directiories with `new_project()`](#create-project-directory)
...
1. [Render all Rmarkdown documents to ./docs/report with `render_all_reports()`](#render-rmarkdown-files-to-reports)
...
* *EcoDynIZW Data*: Template for an Rmarkdown research report for data import and cleaning
